...
class Ticker:
    ...
    def __init__(self, data: Dict[str, Any]):
        ...
        self.best_bid: Optional[float] = float(data["best_bid_price"]) if "best_bid_price" in data else None
        self.best_ask: Optional[float] = float(data["best_ask_price"]) if "best_ask_price" in data else None
        self.index: float = float(data["index"])
        self.mark_ts: float = float(data["mark_timestamp"])
        self.funding_rate: float = float(data["funding_rate"])
